    ...
    public partial class FormMahasiswa : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtNIM.Text)) { MessageBox.Show("NIM harus diisi"); return; }
                if (string.IsNullOrEmpty(txtNama.Text)) { MessageBox.Show("Nama harus diisi"); return; }
